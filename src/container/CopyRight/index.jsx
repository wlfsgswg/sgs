  ...
  render() {
    ...
    const sidebar = (
      <div style={{ width: "200px", padding: "20px" }}>
        ...
        <p>三国杀小伙伴们(排名不分先后)</p>
        <p>
          国当梦、谯雨舍、断剑残垣、丰千秩、辛翱、一梦三江、快船总经理F、星辰遗迹、庞协虑、风流幻、辣B，小心、阿释密达、水是醒来的冰、Knight
          W、陆陆晚安、路西菲菲菲、非洲羊、把卡、刘如青、将进酒、苗并近、中原五百、聂辩、嘛比德、南都屈南子真、
          颜笑醉、ylx羚羊、一只撸猫怪、龙安远、斯库拉、自由之盾、战神灬斗尊...
        </p>
        <p>还有很多，欢迎提醒我会一一补充</p>
      </div>
    );
